...
**the_PhotoMap** is an app that allows the user to search for locations using the [Foursquare API](https://developer.foursquare.com/docs) and create a pin with an image annotation.
...
<img src='https://i.imgur.com/uYQBYEB.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
